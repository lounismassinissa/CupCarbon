 ...
 * @version 1.0
 */
public abstract class Device extends MapObject implements Runnable, _Constantes, Cloneable {
	...
	/**
	 * Set real node parameters
	 *
	 * @param scriptFileName
	 */
	public void setRealNode(String realNodeName) {
	...
	/*
	 * return script file path and name
	 */
	public String getScriptPathName(){
		return Project.getProjectScriptPath()+File.separator+scriptFileName;
	}


	/**
	 * @return getRealNodeParameters
	 */
